...
export class CommonAPIService {
    ...
    public getAdminHeaders(): HttpHeaders {
        this._adminHeaders = new HttpHeaders({ 'Authorization':localStorage.getItem('access_token') });
    ...
    get(url: string, params?: any): Observable<any> {
        ...
        return this.http.get<any>(environment.apiEndpoint + url + "?" + urlSearchParams.toString(), { headers: this.getAdminHeaders() })
            .pipe(
